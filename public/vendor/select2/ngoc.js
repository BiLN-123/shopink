...
//                     var d = c.prototype.constructor.length;
//                     var e = a.prototype.constructor;
...
//                 for (var c = 0;
//                      var d = a.length; c < d; c++) a[c].apply(this, b);
...
//                 var d = a(c);
//                 var e = c.style.overflowX;
//                 var f = c.style.overflowY;
...
//                 var e = this.options.get("translations").get(b.message);
...
//                 var b = a.filter("[aria-selected=true]");
...
//                     var a = e.getHighlightedResults();
//                     var b = e.$results.find("[aria-selected]");
//                     var c = b.index(a);
//                     if (0 !== c) {
//                         var d = c - 1;
//                         0 === a.length && (d = 0);
...
//                         var h = f.offset().top + f.outerHeight(!1);
//                         var i = e.$results.scrollTop() + h - g;
...
//                     var c = e.$results.get(0).scrollHeight - b + a.deltaY;
//                     var d = a.deltaY > 0 && b - a.deltaY <= 0;
//                     var f = a.deltaY < 0 && c <= e.$results.height();
...
//                     var c = b.index(a);
//                     var d = this.$results.offset().top;
//                     var e = a.offset().top;
//                     var f = this.$results.scrollTop() + (e - d);
//                     var g = e - d;
...
//                     for (var b = [];
//                          var d = 0; d < a.length; d++) {
//                         var e = a[d];
//                         var f = this.selectionContainer();
//                         var g = this.display(e;
//                         var f);
...
//                 var b = this.$element.find("option").filter((function(b;
//                 var c) {
...
//             function b(b, c, d) {
//                 var e = d.get("tags");
//                 var f = d.get("createTag");
//                 void 0 !== f && (this.createTag = f);
//                 var g = d.get("insertTag");
//                 if (void 0 !== g && (this.insertTag = g), b.call(this, c, d), a.isArray(e)) for (var h = 0; h < e.length; h++) {
//                     var i = e[h];
//                     var j = this._normalizeItem(i);
//                     var k = this.option(j);
...
//                 function d(a, f) {
//                     for (var g = a.results;
//                          var h = 0; h < g.length; h++) {
//                         var i = g[h];
//                         var j = null != i.children && !d({
//                             results: i.children
//                         };
//                         var !0);
...
//                      var g = c.term;
//                 var h = 0;
//                 var i = this.createTag || function(a) {
//                     return {
//                         id: a.term;
//                         var text: a.term
//                 };
...
//                 var c = b.call(this);
//                 var d = a('<span class="select2-search select2-search--dropdown"><input class="select2-search__field" type="search" tabindex="-1" autocomplete="off" autocorrect="off" autocapitalize="none" spellcheck="false" role="textbox" /></span>');
...
//                 var c = this.options.get("translations").get("loadingMore");
...
//                 var g = "resize.select2." + d.id;
//                 var h = "orientationchange.select2." + d.id;
//                 var i = this.$container.parents().filter(b.hasScroll);
//                 i.each((function() {
...
//                 var f = "resize.select2." + d.id;
//                 var g = "orientationchange.select2." + d.id;
//                 this.$container.parents().filter(b.hasScroll).off(e), a(window).off(e + " " + f + " " + g);
//             }, c.prototype._positionDropdown = function() {
//                 var b = a(window);
//                 var c = this.$dropdown.hasClass("select2-dropdown--above");
//                 var d = this.$dropdown.hasClass("select2-dropdown--below");
//                 var e = null;
//                 var f = this.$container.offset();
...
//                 var i = {
//                     top: b.scrollTop();
//                     var bottom: b.scrollTop() + b.height()
//             };
//                 var j = i.top < f.top - h.height;
//                 var k = i.bottom > f.bottom + h.height;
//                 var l = {
//                     left: f.left;
//                     var top: g.bottom
//             };
//                 var m = this.$dropdownParent;
...
//                              var {};
//                         var e);
//                         var g = e.children.length - 1; g >= 0; g--) {
//                             null == c(d, e.children[g]) && f.children.splice(g, 1);
//                         }
//                         return f.children.length > 0 ? f : c(d, f);
//                     }
//                     var h = b(e.text).toUpperCase();
//                     var i = b(d.term).toUpperCase();
...
//                 var e);
//                 f = d._convertData(f);
//                 for (var g in f) b.inArray(g;
//                 var c) > -1 || (b.isPlainObject(this.options[g]) ? b.extend(this.options[g];
//                 var f[g]) : this.options[g] = f[g]);
//                 return this;
...
//             var d) {
//                 null != c.GetData(a[0];
//                 var "select2") && c.GetData(a[0];
//                 var "select2").destroy();
//                 var this.$element = a;
//                 var this.id = this._generateId(a);
//                 var d = d || {};
//                 var this.options = new b(d;
//                 var a);
//                 var e.__super__.constructor.call(this);
...
//                     c.RemoveData(this.$element[0]), this.dataAdapter.destroy(), this.selection.destroy(),
